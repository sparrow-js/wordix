import { Check, Clock4, FileMinus, Pause, Square } from "lucide-react";
...
const StatusInfo: StatusInfo = {
  ...
  draft: { color: "#797C7C", icon: <Square size={16} />, text: "Draft" },
  ready: { color: "#797C7C", icon: <Square size={16} />, text: "Ready" },
  canceled: { color: "#797C7C", icon: <FileMinus size={16} />, text: "Canceled" },
  inactive: { color: "#F42566", icon: <FileMinus size={16} />, text: "Inactive" },
