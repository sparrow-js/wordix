...
import { EditorAtCommandTunnelContext } from "./editor-at-command";
...
export const EditorRoot: FC<EditorRootProps> = ({ children }) => {
  ...
  const tunnelAtInstance = useRef(tunnel()).current;


  return (
    <Provider store={novelStore}>
      <EditorAtCommandTunnelContext.Provider value={tunnelAtInstance}>
        <EditorCommandTunnelContext.Provider value={tunnelInstance}>{children}</EditorCommandTunnelContext.Provider>
      </EditorAtCommandTunnelContext.Provider>
    </Provider>
  );
};
