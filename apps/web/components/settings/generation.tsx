...
import {generationType, models} from './const';
    ...
    <div className="flex-1 overflow-y-auto">
      <div className="p-8">
        <div data-sentry-component="AttributeEditor" data-sentry-source-file="AttributeEditor.tsx">
            ...
            <div className="font-default">
              <div>
                <div>
                  ...
                  <p className="mt-2">
                    A generation is populated by the language model during program execution based on the parameters set below. To generate the value all the text content that comes <strong>before</strong> this generation is fed to the language model (with any variables replaced with their referenced value) and the "completion" starts from there.
                  </p>
                  <br />
                  <div className="mb-9 mt-5 @container">
                    <p className="font-bold">Name<span className="ml-1 text-xs font-normal text-stone-700"></span></p>
                  ...
                  <div className="mb-9 mt-5 @container">
                    <p className="font-bold">Creativity<span className="ml-1 text-xs font-normal text-stone-700"></span></p>
                    <p className="mb-1 mt-1 text-sm text-stone-400">
                      Determine how creative the generated output will be. Larger values are best for expressive tasks like copy writing and small values are preferred for predictable tasks such as format conversion
                    </p>
                    <Slider
                      min={0}
                      max={100}
                    ...
                    <ul className="flex w-full justify-between px-0">
                      <li className="select-none text-xs text-stone-400"><span>consistent</span></li>
                      <li className="select-none text-xs text-stone-400"><span>creative</span></li>
                    </ul>
                  </div>
                  <div>
                    <div className="mb-9 mt-5">
                      <p className="font-bold">Generation type<span className="ml-1 text-xs font-normal text-stone-700"></span></p>
                  ...
                  <div className="mb-9 mt-5">
                    <p className="font-bold">Model<span className="ml-1 text-xs font-normal text-stone-700"></span></p>
                    <p className="mb-1 mt-1 text-sm text-stone-400">Choose which model should be used for this generation</p>
                  ...
                  <div className="mt-4">
                    <div className="border-b">
                      <button>
                        <h3 className="flex">
                          <button type="button" aria-controls="radix-:rsq:" aria-expanded="false" id="radix-:rsp:" className="flex flex-1 items-center justify-between py-4 font-medium transition-all hover:underline [&[data-state=open]>svg]:rotate-180">
                            Legacy models
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-chevron-down h-4 w-4 shrink-0 transition-transform duration-200">
                              <path d="m6 9 6 6 6-6"></path>
                            </svg>
                          </button>
                        </h3>
                      </button>
                      <div data-state="closed" id="radix-:rsq:" role="region" aria-labelledby="radix-:rsp:" className="overflow-hidden text-sm transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down" 
                       ></div>
                    </div>
                  </div>
                  <div className="mb-2 mt-4"></div>
                  <div>
                    <a target="_blank" className="text-sm text-sky-600 hover:underline" href="https://www.notion.so/hey-daily/Models-615b76d7498f4e06ae522a329695da74">Model documentation</a>
                  </div>
                </div>
              </div>
              <div className="mt-12 flex w-full justify-center">
                <button className="mt-6 flex items-center rounded border px-4 py-2 text-sm font-semibold uppercase tracking-tight text-stone-600 hover:bg-red-500 hover:text-white active:bg-red-600">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-trash2 mr-2 h-4 w-4">
                    <path d="M3 6h18"></path>
          ...
          <p className="mt-16 align-bottom font-mono text-xs text-stone-200">Selected id: 13c56322-a152-4e97-a0cd-6750a4b1756c</p>
        </div>
      </div>
    </div>
  );
