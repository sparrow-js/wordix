...
const ImagePreview: FC<ImagePreviewProps> = ({ url, title, onCancel }) => {
  ...
  return createPortal(
    <div
      className="fixed inset-0 p-8 flex items-center justify-center bg-black/80 z-[1000] image-preview-container"
