interface Tool {
  ...
  const systemPrompt: SystemPrompt = {
    ...
    Thought: I will use javascript code to compute the result of the operation and then return the final answer using the \`final_answer\` tool
    Code:
    \`\`\`js
    result = 5 + 3 + 1294.678
    final_answer(result)
    ...
    Code:
    \`\`\`js
 const translated_question = translator({question: question, src_lang: "French", tgt_lang: "English"});
    console.log(\`The translated question is \${translated_question}.\`);
    const answer = image_qa({image: image, question: translated_question});
    ...
    Code:
    \`\`\`js
    pages = search("1979 interview Stanislaus Ulam Martin Sherwin physicists Einstein")
    console.log(pages)
    \`\`\`<end_code>
    Observation:
    ...
    Code:
    \`\`\`js
    pages = search("1979 interview Stanislaus Ulam")
    console.log(pages)
    \`\`\`<end_code>
    Observation:
    Found 6 pages:
    ...
    Code:
    \`\`\`js
   ["Guangzhou", "Shanghai"].forEach(city => {
    ...
    Code:
    \`\`\`js
    const pope_age_wiki = wiki({query: "current pope age"});
    console.log("Pope age as per wikipedia:", pope_age_wiki);
    const pope_age_search = web_search({query: "current pope age"});
    console.log("Pope age as per google search:", pope_age_search);
    \`\`\`<end_code>
    Observation:
