...
// Example usage of the interfaces and const
const tools: Tool[] = [
  {
    name: "document_qa",
    description: "Answers questions based on document content.",
...
// Example task
const task = "Generate an image of the oldest person in this document.";
