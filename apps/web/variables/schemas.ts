...
export type VariableWithUnknowValue = z.infer<typeof variableWithUnknowValueSchema>;

export const variableStringSchema = z.custom<`{{${string}}}`>((val) => /^{{.+}}$/g.test(val as string));
...
// z.ZodType<Prisma.SetVariableHistoryItem>;

export type SetVariableHistoryItem = z.infer<typeof setVariableHistoryItemSchema>;
