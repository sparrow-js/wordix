    ...
    <div className="flex flex-col min-h-screen">
      <header className="fixed top-0 left-0 right-0 z-50 px-4 lg:px-6 h-16 flex items-center border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 shadow-sm">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="ml-2 text-lg font-bold">DocFlow</span>
        </Link>
      ...
      <main className="flex-1">
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Efficient collaboration, fast approvals, secure storage. Let DocFlow be your trusted assistant in
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-3">
              <FeatureCard
                ...
                description="Automatic categorization, version control, and quick retrieval make document management effortless."
              />
              <FeatureCard
                icon={<Users className="h-10 w-10" />}
                title="Seamless Collaboration"
                description="Real-time editing, commenting, and sharing to enhance team collaboration efficiency."
              />
              <FeatureCard
                icon={<Zap className="h-10 w-10" />}
                title="Automated Workflows"
                description="Customize approval processes, set automatic reminders, and accelerate document turnaround."
              />
              <FeatureCard
                icon={<BarChart className="h-10 w-10" />}
                title="Advanced Analytics"
                description="Gain insights into document usage, team productivity, and workflow efficiency with detailed reports."
              />
              <FeatureCard
                icon={<Shield className="h-10 w-10" />}
                title="Enterprise-Grade Security"
                description="Protect your sensitive information with state-of-the-art encryption and access controls."
              />
              <FeatureCard
                icon={<Globe className="h-10 w-10" />}
                title="Global Accessibility"
                description="Access your documents from anywhere, on any device, with our cloud-based solution."
              />
            </div>
          </div>
        </section>
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-8">
              <WorkflowStep number={1} title="Create" description="Draft and upload documents with ease" />
              <ArrowRight className="hidden md:block h-8 w-8 text-gray-400" />
              <WorkflowStep number={2} title="Collaborate" description="Work together in real-time" />
              <ArrowRight className="hidden md:block h-8 w-8 text-gray-400" />
              <WorkflowStep number={3} title="Approve" description="Streamline the review process" />
              <ArrowRight className="hidden md:block h-8 w-8 text-gray-400" />
              <WorkflowStep number={4} title="Archive" description="Securely store and easily retrieve" />
            </div>
          </div>
        </section>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <PricingCard
                ...
                features={["Up to 5 team members", "5GB storage", "Basic workflow automation", "Email support"]}
              />
              <PricingCard
                title="Professional"
                price="$29"
        ...
        <section id="testimonials" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <TestimonialCard
                quote="DocFlow has revolutionized our document management process. It's intuitive, efficient, and has saved us countless hours."
                author="Sarah Johnson"
                title="CEO, TechInnovate Inc."
              />
              <TestimonialCard
                quote="The collaboration features in DocFlow are unparalleled. Our team's productivity has skyrocketed since we started using it."
                author="Michael Chen"
                title="Project Manager, GlobalSoft Solutions"
              />
              <TestimonialCard
                quote="As a legal firm, security is our top priority. DocFlow's robust security features give us peace of mind with our sensitive documents."
                author="Emily Rodriguez"
                title="Partner, LegalEagle LLP"
              />
            </div>
          </div>
        </section>
...
function WorkflowStep({ number, title, description }) {
  return (
    <div className="flex flex-col items-center text-center">
      <div className="mb-2 rounded-full bg-primary text-primary-foreground w-14 h-14 flex items-center justify-center text-xl font-bold shadow-lg">
        {number}
      </div>
