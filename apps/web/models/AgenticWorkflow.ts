import type AgenticWorkflowsStore from "@/stores/agenticWorkflowsStore";
import { action, computed, makeObservable, observable } from "mobx";
import Model from "./base/Model";

class AgenticWorkflow extends Model {
  static modelName = "AgenticWorkflow";
  ...
  declare store: AgenticWorkflowsStore;

  @observable
  documentId: string;

  constructor(fields: Record<string, any>, store: AgenticWorkflowsStore) {
    super(fields, store);
    makeObservable(this);
  ...
  @action
  update(data: Partial<AgenticWorkflow>) {
...
export type AgenticWorkflowType = AgenticWorkflow;
